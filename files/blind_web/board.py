...
def write() :
    if request.method == 'GET' :
        response = requests.get(f'http://internal-internalELB-newnew-943065277.ap-northeast-1.elb.amazonaws.com/board/write', proxies=proxies)
        return response.text
    elif request.method == 'POST' :
        form_data = request.form
        response = requests.post(f'http://internal-internalELB-newnew-943065277.ap-northeast-1.elb.amazonaws.com/board/write', data=form_data, proxies=proxies)
        return response.text
...
def detail(num) :
    ...
    response = requests.get(f'http://internal-internalELB-newnew-943065277.ap-northeast-1.elb.amazonaws.com/board/detail/{num}', proxies=proxies)
